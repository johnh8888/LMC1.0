...
class ExactBetBackTest:
    ...
    def simulate_mode(self, mode="半波", test_days=10):  # ← 改成半波模式
        """
        模拟下注模式
    ...
    def print_report(self, mode="半波", test_days=10):  # ← 改成半波模式
        """打印详细报告"""
