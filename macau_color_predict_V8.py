...
REPORT_FILE="newmacau_result_v817.md"
BET_RECORD_FILE="newmacau_bet_record_v817.md"
...
class BetRecord:
    ...
    def save_to_file(self):
        ...
        with open(BET_RECORD_FILE, "w", encoding="utf-8") as f:
            f.write("# 新澳门彩下注记录（动态半波版 V8.17 颜色分散优化）\n\n")
...
def main():
    ...
    print("=" * 50)
    print("🎯 新澳门彩预测系统 V8.17（动态半波版 颜色分散优化）")
    print("   基于老澳门V8.16完整迁移")
    print("=" * 50)
    ...
    print(
        ...
        "新澳门彩 V8.17 BALANCE预测（动态半波版 颜色分散优化）"
